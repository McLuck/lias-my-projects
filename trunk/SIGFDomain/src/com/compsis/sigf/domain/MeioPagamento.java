 ...
 * 
 */
public class MeioPagamento extends DomainObject implements Replicable, Serializable{
    ...
    public String toString(){
    	MeioPagamento m = (MeioPagamento)replicate(null);
		return new Gson().toJson(m, MeioPagamento.class);
	}
