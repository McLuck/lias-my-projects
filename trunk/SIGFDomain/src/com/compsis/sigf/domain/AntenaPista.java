 ...
 * 
 */
public class AntenaPista extends DomainObject implements Replicable, Serializable{
    private String fabricante;
    private String modelo;
    private int interfaceAcesso;
    private transient ConfiguracaoPraca configuracaoPraca;
    
    public String toString(){
    	AntenaPista c = (AntenaPista)replicate(configuracaoPraca);
    	Gson gson = new GsonBuilder().excludeFieldsWithModifiers(new int[]{Modifier.STATIC, Modifier.TRANSIENT, Modifier.VOLATILE}).create();
		return gson.toJson(c,AntenaPista.class);
	}
