...
----------------------------
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (1,'Configuracao/actionOperador.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (1,'/Configuracao/actionCargo.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (1,'/Configuracao/actionPerfil.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (2,'Configuracao/actionProgramacaoTarifa.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3,'Configuracao/actionHorarioVerao.do',0,null);
--4 nao tem
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (5,'Configuracao/actionConfiguracaoArrecadacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (6,'Configuracao/actionContaBanco.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (7,'Configuracao/actionTransportadora.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (8,'Configuracao/actionClasseTarifa.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (9,'Caixa/Configuracao/actionPacote.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (10,'Caixa/Configuracao/actionAgrupamento.do',0,null);
--11 nao tem
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (12,'Caixa/Configuracao/actionArea.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (13,'Caixa/Configuracao/actionDenominacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (14,'Configuracao/actionEmissorCupom.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (15,'Cheque/actionCheque.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (15, '/Transacao/actionCancelamentoTransacao.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (15, '/Malote/actionMalote.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (15, '/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (16,'Isento/actionVeiculoIsento.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (17,'Isento/actionTipoDeIsento.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (19,'Configuracao/actionConfiguracaoSistema.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (19,'/Configuracao/actionPista.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (20,'Declaracao/actionDeclaracao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (20,'Declaracao/actionDevolucaoTrocoExplicita.do',0,NULL);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (21,'Caixa/actionManipuladorSessaoCaixa.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (22,'Declaracao/actionDeclaracao.do',0,null);
--23 incluir qdo tiver ohl 
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (24,'Declaracao/actionDeclaracao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (25,'Declaracao/actionDeclaracao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (26,'Periodo/actionPeriodo.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (27,'Configuracao/actionRetiradaCupomParaVenda.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (28,'Declaracao/actionDeclaracao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (29,'Sumario/actionRegistroRecalculoSumario.do',0,null);
--30a32 --incluir qdo necessário
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (33,'NotaDebitoCredito/actionNotaDebitoCredito.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (34,'/Configuracao/actionAlteracaoSenhaCV.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (50,'Malote/actionMalote.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (50,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (50,'/Transacao/actionCancelamentoTransacao.do', 0, null);
--51 nao tem
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'Caixa/actionCaixa.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionLancamentos.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionAbertura.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionEntregaTroco.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionFormacaoAgrupamentos.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionDesagrupar.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionReconstituicaoTroco.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionCompactacaoPacotes.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionDescompactacaoPacotes.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionAjusteArea.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionTrocaAreas.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionTrocaExterna.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionMalotes.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionAporte.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionSaldos.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionRecebimentoValoresApropriaveis.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (52,'/Caixa/actionAjusteEntregaTroco.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (53,'Caixa/actionFechamentoForcado.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (54,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (54,'/Transacao/actionCancelamentoTransacao.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (54,'Malote/actionMalote.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (55,'Malote/actionMalote.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (55,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (55,'/Transacao/actionCancelamentoTransacao.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (56,'/Transacao/actionCancelamentoTransacao.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (56,'Malote/actionMalote.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (56,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (57,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (57,'/Transacao/actionCancelamentoTransacao.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (57,'Malote/actionMalote.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (60,'Transacao/actionCorrecaoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (60,'/Sumario/actionRegistroRecalculoSumario.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (60,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (60,'/Transacao/actionProcessamentoArquivo.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (60,'/Transacao/actionInsercaoManual.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (61,'Transacao/actionCorrecaoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (62,'Transacao/actionCorrecaoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (62,'/Sumario/actionRegistroRecalculoSumario.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (62,'/Transacao/actionBufferMensagem.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (62,'/Transacao/actionProcessamentoArquivo.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (62,'/Transacao/actionInsercaoManual.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (63,'Transacao/actionProcessamentoArquivo.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (64,'Transacao/actionBufferMensagem.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (65,'Transacao/actionBufferMensagem.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (66,'Transacao/actionBufferMensagem.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (67,'Transacao/actionBufferMensagem.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (68,'Falha/actionRegistroDeFalha.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (69,'Configuracao/actionCupom.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (70,'Recebimento/actionDividasOperadores.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (72,'Transacao/actionBufferMensagem.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (73,'Transacao/actionCorrecaoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (74,'Recebimento/actionPagamentosDiversos.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (75,'Recebimento/actionTransacoes.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (76,'Ocorrencia/actionOcorrencia.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (77,'Transacao/actionTransacao.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (78,'Transacao/actionAlocacaoPista.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (79,'Transacao/transacaoVelocidade.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (79,'Transacao/actionTransacao.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (80,'TrilhaAuditoria/actionTrilhaAuditoria.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (81,'TrilhaAuditoria/actionTrilhaAuditoria.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (82,'Relatorio/actionRelatorio.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (83,'Ocorrencia/actionProcessoOcorrencia.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (83, 'Ocorrencia/actionRegistroOcorrencia.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (84, 'Configuracao/actionAjusteRetiradaCupons.do', 0, null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (85,'/Configuracao/actionSumarioCupons.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (86,'Isento/actionUsuarioLocal.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (86,'Isento/actionVeiculoLocal.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (87,'Isento/actionVeiculoIsento.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (88,'ConfiguracaoInterop/actionHistoricoCadastro.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (89,'Isento/actionVeiculoIsento.do',0,null);
--90 é botao
--91 nao tem
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (92,'Transacao/actionCorrecaoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (93,'RecebimentoCadastro/actionRecebimentoCadastro.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (94,'Configuracao/actionOperador.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (95,'/Transacao/actionInsercaoManual.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (96,'ConfiguracaoInterop/actionFeriadoBancario.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97,'/Configuracao/actionConfiguracaoPreCorrecao.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97,'/Transacao/actionCorrecaoTransacao.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97, '/Sumario/actionRegistroRecalculoSumario.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97, '/Transacao/actionBufferMensagem.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97, '/Transacao/actionProcessamentoArquivo.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97, '/Transacao/actionInsercaoManual.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97, '/Caixa/actionAjusteEntregaTroco.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97, '/Caixa/actionConsultaTag.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (97,'Configuracao/actionConfiguracaoPreCorrecao.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (98,'Transacao/actionCorrecaoTransacao.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (98,'/Transacao/actionCorrecaoTransacao.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (98,'/Sumario/actionRegistroRecalculoSumario.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (98,'/Transacao/actionBufferMensagem.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (98,'/Transacao/actionInsercaoManual.do', 0, null);
--99 nao tem
--100 nao tem
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (101,'Transacao/actionArquivoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (103,'Transacao/actionNotificacaoEventos.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (104,'RegistroRecebimentoPagtoLotes/actionRegistroRecebimentoPagtoLotes.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (105,'Contas/actionTipoOrganizacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (106,'Contas/actionDepartamento.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (107,'Contas/actionDivisao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (108,'Contas/actionQualificacao.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (109,'Contas/actionContas.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (110,'Contas/actionContas.do',0,null);
--111 a 115 é botao
--116 nao tem
--117 incluir qdo tiver lpr
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (118,'Contas/actionHistoricoTag.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (119,'Configuracao/actionMotivoImpressao.do',0,null);
--121
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (122,'Configuracao/actionExportacaoArquivoERP.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (123,'Configuracao/actionDescontoIntervaloTempo.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (124,'Transacao/actionInsercaoManualMeioPagamento.do',0,null);
--125 nao tem
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (126, 'Sinotico/actionSinoticoPistas.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (126, 'Transacao/actionCorrecaoTransacao.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (127,'Configuracao/actionConfiguracaoCategorias.do',0,null);
--insert into funcionalidadeacesso (IdFuncionalidade, Acesso, NivelPorMetodo, AcessoMetodo)values (127,'/Configuracao/actionProgramacaoTarifa.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (128,'Configuracao/actionConfiguracaoPista.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (129,'Interoperabilidade/actionEmailEtapaInteroperacao.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (130,'Interoperabilidade/actionEmailEtapaInteroperacao.do', 0, null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (131, 'Configuracao/actionEmailAcompanhamentoVDA.do', 0 , null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (132, 'Interoperabilidade/actionRecebimentoDescManut.do', 0, NULL);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (133, 'Interoperabilidade/actionConfiguracaoDescManut.do', 0, NULL);

insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3000,'RecebimentoCadastro/actionRecebimentoCadastro.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3001,'ConfiguracaoInterop/actionConfiguracaoInterop.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3002,'VisualizaRecebimentoCadastro/actionVisualizaRecebimentoCadastro.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3003,'ManipulacaoTransacoes/actionManipulacaoTransacoes.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3003,'Transacao/actionCorrecaoTransacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3004,'GeracaoLotes/actionGeracaoLotes.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3005,'ManipulacaoLotes/actionManipulacaoLotes.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3006,'RecebimentoProtocolo/actionRecebimentoProtocolo.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3007,'VisualizacaoLotes/actionVisualizacaoLotes.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3009,'/ConfiguracaoInterop/actionConsultaTag.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3010,'LogEventosInteroperacao/actionLogEventosInteroperacao.do',0,null);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3011,'ArquivosInterop/tarifaArquivoInterOp.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3013, 'ValePedagio/actionValePedagio.do', 0, NULL);
insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3014,'ConfiguracaoInterop/actionConfiguracaoMensagensIT.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3015,'ControleDesconto/perfilDesconto.do',0,null);
--insert into funcionalidadeacesso (idfuncionalidade, acesso, nivelpormetodo, acessometodo)values (3016,'ControleDesconto/midiaPerfilDesconto.do',0,null);
