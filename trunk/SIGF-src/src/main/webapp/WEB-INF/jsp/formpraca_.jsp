...
<body onclick="closeAllNews(event);">
...
%>
			...
			<form action="gerenciarPracasCompleta.htm?dominio=praca&cmd=novo2" method="POST" id="form_dados_praca"
				...
				<fieldset
					...
					<div style="float: left;">
						<label>Nome:</label>
						<form:input path="praca.nome" onkeypress="changer(this, event);" placeholder="Nome da praça"
					...
					<div style="float: left; margin-right: 5px; float: right;">
						...
						<form:input cssStyle="margin-right: 5px;width: 290px;"
							...
							id="cnpj" alt="cnpj" onblur="sairCNPJ();" maxlength="18" placeholder="00.000.000/0000-00" />
					</div>
						...
						<table width="100%" class="display">
								...
								<tr>
									...
									<th width="199">Sentido
										<div id="iconsEdit_loc_tit" style="display: none; width: 60px; float: right;">
											<img alt="Cancelar" title="Cancelar" src="images/cancelar1.png" style="width: 15px; height: 15px; border: 0px;" onclick="onClickFimEditLocal();" />
							...
							<tbody>
									...
									<c:if test="${lcs!=null}">
										...
										<tr style="display: none;" id="edit_loc_${lcs.id}"  onmouseover="viewIconsLocais(${lcs.id});" onmouseout="hideIconsLocais(${lcs.id});"
											...
											<form id="formLocal_edt${lcs.id}" name="formLocal_edt${lcs.id}" action="#" onsubmit="return false;">
												<td width="92">
													<input maxlength="1" type="text" name="cod_local" placeholder="0" style="width: 96px;" id="cod_local${lcs.id}" value="${lcs.numero}" size="16" />
												</td>
													<td width="498px">
														<input type="text" name="desc_loc" style="width: 498px;" id="desc_loc" value="${lcs.descricao}" size="76" maxlength="30" placeholder="Localização 0" />
													</td>
								...
								<tr id="trLabelNovaLocal">
									<td onclick="showNewLocal(event);" style="text-align: center; color: #0000FF; text-decoration: underline; font-weight: bold;" colspan="4">
										Nova Localização
									</td>
								</tr>
								<tr class="even2" style="display: none;" onclick="ignoreClick(event);" id="trNewLocal" >
									<form id="formLocal_edt00" name="formLocal_edt00" action="#" onsubmit="return false;">
										...
										<td width="498px">
											<input type="text" name="desc_loc" style="width: 498px;" maxlength="30" placeholder="Localização 0" id="desc_loc00" size="76" />
										</td>
										<td width="199">
								...
								<tbody>
										...
										<c:if test="${lcs!=null}">
											...
											<tr style="display: none;" id="edit_pst_${lcs.id}" onclick="ignoreClick(event);" onmouseover="viewIcons(${lcs.id});" onmouseout="hideIcons(${lcs.id});"
												...
												<form sction="#" onsubmit="return false" name="formPista_edt_${lcs.id}" id="formPista_edt_${lcs.id}">
													<td width="50">
													<input type="text" name="cod_pst" placeholder="0" maxlength="2"
														id="cod_pst" value="${lcs.numeroPista}" size="20" style="width: 54px;" />
													</td>
													...
													<td width="160">
													<input type="text" name="nomeMaquina" placeholder="P1CV00" id="nomeMaquina${lcs.id}" style="width: 177px;"  value="${lcs.nomeMaquina}" size="23"/></td>
													<td width="134">
														<input type="text" placeholder="00.00.00.00"
															name="ipMaquina"
									...
									<tr class="even2" id="trNewPista" style="display: none;" onclick="ignoreClick(event);" >
										<form action="#" onsubmit="return false" name="formPista_edt_000" id="formPista_edt_000">
													<td width="50">
														<input type="text" maxlength="2" placeholder="0" nextinput="desc_loc_pista000" name="cod_pst" id="cod_pst000" size="20" style="width: 54px;" />
													</td>
													<td width="100">
													...
													<td width="160">
														<input maxlength="30" type="text" name="nomeMaquina" onkeypress="proximoCampo(this, event, 'ipMaquina000');" placeholder="P1CV00" id="nomeMaquina000" style="width: 177px;"  size="23"/>
													</td>
													<td width="134">
													<!-- onkeypress="return ( maskIP(event,this) );" -->
														<input type="text" placeholder="00.00.00.00"
															name="ipMaquina"
															style="width: 130px;float: left;" id="ipMaquina000" size="15"
	...
	<div style="float: right;margin-right: 4px;">
						...
						<a href="gerenciarPracasCompleta.htm?cid=${cid}&cmd=novo">
							<input type="image" src="images/novo.png" style="width: 60px;padding-top: 16px;display: inline;" />
						</a>
						<input type="image" src="images/salvar_img.png" style="width: 60px;padding-top: 16px;height: 29px;display: inline;" onclick="pracaSubmit();" />
	</div>
</body>
</html>