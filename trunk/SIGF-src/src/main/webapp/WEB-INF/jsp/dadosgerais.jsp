			...
			<fieldset>
				...
				<div id="frameOpcoesTable" style="height: 24px;">
					<div id="opcoesEffects" style="display: none; background-color: #EEEEEE; float:right;" class="ui-state-default ui-corner-all">
						<div class="icone-horizontal novo-documento16" onclick="window.open('gerenciarPracasCompleta.htm?cid=${cid}&cmd=novo', 'Pracas', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=110, LEFT=110, WIDTH=900, HEIGHT=640');" title="Novo"></div>
						<div class="icone-horizontal edit-documento16" title="Alterar" onclick="window.open('gerenciarPracasCompleta.htm?cid=${cid}&pracaid='+idRegistro, 'Pracas', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=110, LEFT=110, WIDTH=900, HEIGHT=640');"></div>
						<div class="icone-horizontal del-documento16" title="Apagar" onclick="deletePraca(${cid});"></div>
						<div class="icone-horizontal abrir-documento16" title="Abrir" onclick="window.open('gerenciarPracasCompleta.htm?cid=${cid}&pracaid='+idRegistro, 'Pracas', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=110, LEFT=110, WIDTH=900, HEIGHT=640');"></div>
					</div>
				</div>
