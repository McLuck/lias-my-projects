        ...
        <form action="#" name="formConfirmAcesso" id="formConfirmAcesso"  onsubmit="return false;">
            ...
            <fieldset>
                ...
                <div id="frame_senha_avancado" style="margin-top: 5px; <c:if test="${ca.complexidade!=2}">display: none;</c:if>">
                    Não conter <input type="text" style="display: inline;" onkeyup="refreshDiasConfigAcesso();" name="qtdMinimaSegura" id="qtdMinimaSegura" value="${ca.qtdMinimaSegura}" size="3" /> do mesmo tipo; <br />
            ...
            <label>Validade da senha (dias):</label> <input type="text" value="${ca.senhaValidade}" id="senhaValidade" name="senhaValidade" size="4" />
            <label>Quantidade de senhas restradas:</label><input type="text" value="${ca.qtdRegistroSenha}" id="qtdRegistroSenha" name="qtdRegistroSenha" size="3" />
