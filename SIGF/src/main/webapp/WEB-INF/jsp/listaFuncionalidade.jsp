                ...
                <c:forEach items="${lista}" var="r">
                    <tr style="text-align: center;">
                        ...
                        <td style="text-align: center;" width="20px">
                            <input type="checkbox" class="SpecialCaseForLabel" name="utilizado${r.funcionalidade.id}" onchange="clickSave(${r.funcionalidade.id}, ${cid});" id="utilizado${r.funcionalidade.id}" <c:if test="${r.ativo}">checked="true"</c:if> value="true" />
                        </td>
                    </tr>
                </c:forEach>
            </table>
