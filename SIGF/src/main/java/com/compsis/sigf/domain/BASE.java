...
public class BASE {
    ...
    public static class TIPOS {
         ...
         * <b>Valor: 1</b>
         */
        public static final int SA_CENTRALIZADO = 1, TIPO_PISTA_MOTO = 1, CALCULO_CAT_ESPECIAL_MODALIDADE_1 = 1, TIPO_CATEGORIA_MOTO = 1;
        /**
         * <b>Valor: 2</b>
         */
        public static final int SA_DISTRIBUIDO = 2, TIPO_PISTA_MANUAL = 2, CALCULO_CAT_ESPECIAL_MODALIDADE_2 = 2, TIPO_CATEGORIA_PASSEIO = 2;
        /**
         * <b>Valor: 3</b>
         */
        public static final int TIPO_PISTA_AUTOMATICA = 3, TIPO_CATEGORIA_COMERCIAL = 3, SENTIDO_REVERSIVEL = 3;
        /**
         * <b>Valor: 4</b>
         */
         ...
         * <b>Valor: 6</b>
         */
        public static final int TIPO_PISTA_MISTA = 6;

        public static String GET_MODO_OPERACAO_SA(int s) {
            switch (s) {
                case SA_CENTRALIZADO:
                    return "Centralizado - Um servidor para a ConcessionÃ¡ria toda. NecessÃ¡rio link entre as praÃ§as.";
                case SA_DISTRIBUIDO:
                    return "DistribuÃ­do - Um servidor por praÃ§a.";
                default:
                    return "Outro";
            }
        }
