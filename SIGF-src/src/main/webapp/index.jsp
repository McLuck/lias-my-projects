...
<%
	...
	if(cid==null){
		cid = request.getAttribute("cid")!=null?String.valueOf(request.getAttribute("cid")):null;
		cnome = request.getAttribute("cnome")!=null?String.valueOf(request.getAttribute("cnome")):null;
	}
	if(cid==null){
		cid = request.getAttribute("cid")!=null?String.valueOf(session.getAttribute("cid")):null;
		cnome = request.getAttribute("cnome")!=null?String.valueOf(session.getAttribute("cnome")):null;
	}
	if(cid==null){
		response.sendRedirect("semConcessionaria.jsp");
	}	
%>
<!DOCTYPE html>
<html lang="pt-br">
	<head>
		...
		content="SIGF." />
		<title>SIGF - Editando <%=cnome%></title>
	...
	<body>
		...
		<div class="abs" id="wrapper">
			<div class="abs" id="desktop">
				...
				<a class="abs icon" style="left: 20px; top: 340px;" target="_self" href="#" ondblclick="window.location.href='semConcessionaria.jsp';"> <img src="images/logout-24.png" />Sair <span id="titConfigPraca">&nbsp;</span></a>
				 <!--a
				class="abs icon" style="left: 20px; top: 260px;"
				href="#icon_dock_network"> <img
			...
			<span style="float: right; font-weight: bold; font-size: 14px; padding: 4px;" id="concstatus"><%=cnome%></span>
		</div>
		<script
