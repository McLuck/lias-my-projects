                ...
                <c:forEach items="${lista}" var="r">
                    <tr>
                        ...
                        <td style="text-align: center;">
                            <input type="checkbox" style="float: none;" class="SpecialCaseForLabel" name="utilizado${r.relatorio.id}"  onchange="clickSaveRel(${r.relatorio.id}, ${cid});" id="utilizado${r.relatorio.id}" <c:if test="${r.ativo}">checked="true"</c:if> value="true" />
                        </td>
                    </tr>
                </c:forEach>
            </table>
